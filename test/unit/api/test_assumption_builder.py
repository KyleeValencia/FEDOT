...
def test_assumptions_builder_for_multimodal_data():
    ...
    mm_builder = MultiModalAssumptionsBuilder(task, mm_data)
...
def test_assumptions_builder_unsuitable_available_operations():
    ...
    default_builder = UniModalAssumptionsBuilder(task, train_input)
    checked_builder = UniModalAssumptionsBuilder(task, train_input).from_operations(available_operations)
...
def impl_test_assumptions_builder_suitable_available_operations(
    ...
    default_builder = AssumptionsBuilder.get(task, train_input)
    ...
    checked_builder = AssumptionsBuilder.get(task, train_input).from_operations(available_operations)
